...
function VoiceSettingsSection() {
  ...
  return React.createElement("div", null,
    ...
    React.createElement("div", { style: styles.sectionTitle }, "场景提示音（语音播报前先响一声，音量已 +50%）"),
    React.createElement("div", { style: styles.hint }, "每个场景可独立选提示音：蜂鸣（系统内置）或内置 WAV 音效；播放时自动放大 50% 音量，语音音量不受影响"),
    SCENE_NAMES.map((s) =>
