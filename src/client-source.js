...
function VoiceSettingsSection() {
  ...
  return React.createElement("div", null,
    ...
    // ── MiMo 区块（默认展开，在火山上方）──
    React.createElement(CollapsibleSection, { title: "MiMo 小米云 TTS（mimo.mi.com）", open: openMimo, onToggle: () => setOpenMimo(!openMimo) },
      React.createElement("div", { style: styles.row },
    ...
    // ── 火山区块（默认折叠，在 MiMo 下方）──
    React.createElement(CollapsibleSection, { title: "火山引擎（volcano · seed-tts）", open: openVolcano, onToggle: () => setOpenVolcano(!openVolcano) },
      React.createElement("div", { style: styles.row },
